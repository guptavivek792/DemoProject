package com.healogics.pretx.domain.datatype;
...
/**
 * Hibernate user type for json mapping for postgres
 */
public class JsonDataType implements UserType {

	/**
	 * Returns the SQL type codes for the columns mapped by this type. The codes are
	...
	public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner)
		...
		try {
			jsonObject = mapper.readValue(rs.getString(names[0]), JsonNode.class);
		} catch (Exception ex) {
	 ...
	 * in which case it is safe to simple return the argument.
	 * 
	 ...
	 * merging. For immutable objects, or null values, it is safe to return a copy
	 * of the first parameter. For the objects with component values, it might make
	 * sense to recursively replace component values
	 * 
